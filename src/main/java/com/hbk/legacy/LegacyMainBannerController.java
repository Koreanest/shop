...
public class LegacyMainBannerController {

    private final LegacyMainBannerService service;
    ...
    public LegacyMainBannerResponse createReplace(
    ...
    public LegacyMainBannerResponse update(
            @RequestParam(required = false) String linkUrl,
